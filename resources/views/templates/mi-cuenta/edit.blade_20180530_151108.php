      ...
      <div class="page-body">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="alert alert-success">
                <p>Favor completar todos los datos para poder brindarte una mejor experiencia como Colaborador.</p>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      ...
                      <div class="form-group">
                        ...
                        {!! Form::text('tipo_oportunidad', Auth::user()->tipo_oportunidad ? Auth::user()->tipo_oportunidad : null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Tipo de oportunidad. Ej: becas, oportunidad laboral, cursos, talleres, voluntariado, otros.']) !!}
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="alert alert-success">
                <p>Favor completar todos los datos para poder brindarte una mejor experiencia como Usuario.</p>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        {!! Form::text('tipo_oportunidad', Auth::user()->tipo_oportunidad ? Auth::user()->tipo_oportunidad : null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Tipo de oportunidad']) !!}
